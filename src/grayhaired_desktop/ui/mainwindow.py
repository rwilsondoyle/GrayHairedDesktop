...
class MainWindow(QMainWindow):
    ...
    def apply_startup_mode(self) -> DesktopModePath:
        ...
        # Version 1.0 always starts as the supported normal window, even when a
        # pre-PR #48 settings file contains the retired Desktop Mode value.
        return self._apply_desktop_mode(
            startup_desktop_mode_requested(self._preferences)
        )
