...
My Desktop is the public display name. GrayHairedDesktop remains the repository, package, and internal compatibility identity; existing settings, application IDs, launcher filenames, and paths remain stable. GrayHaired Tech and Ron Doyle remain appropriate project attribution.
