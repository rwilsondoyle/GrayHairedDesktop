...
repository, package, and internal compatibility identity. GrayHaired Tech and
Ron Doyle are appropriate project attribution. Release-readiness work must not
rename the repository, package, QSettings scope, application IDs, or data paths.
