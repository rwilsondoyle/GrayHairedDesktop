...
My Desktop is the public/display product name; GrayHairedDesktop remains the repository, package, launcher, QSettings, and internal compatibility identity. GrayHaired Tech and Ron Doyle are appropriate project attribution. Release-readiness work must not rename the repository, package, QSettings identity, or application data paths.
